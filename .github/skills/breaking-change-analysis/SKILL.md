...
- Current release line: v5.x (heading to v6.0.0)
- Breaking changes are batched for major releases (v6.0.0)
- Use deprecation warnings in the current release line before removal in the next major

**Deprecation approach:**

```ruby
# @deprecated Use {#new_method} instead. Will be removed in v6.0.
def old_method(*args)
