  ...
  module Commands
    module Stash
      ...
      class Show < Git::Commands::Base
        ...
        #
        #     @option options [Integer] :unified (nil) generate diff with <n> lines of context
        #
        #       Alias: :U
        #
        ...
        #
        #     @option options [Integer] :inter_hunk_context (nil) show context between diff hunks, up to
