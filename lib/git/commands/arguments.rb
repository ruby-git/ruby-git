...
module Git
  module Commands
    ...
    class Arguments
      ...
      # Raise unless the key is a lowercase snake_case identifier
      #
      # @param key [Symbol] the option name to validate
      ...
      # @raise [ArgumentError] if required is true and allow_nil is false
      #
