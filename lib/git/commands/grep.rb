...
module Git
  module Commands
    ...
    #   grep = Git::Commands::Grep.new(execution_context)
    #   result = grep.call('HEAD', pattern: 'search', path_limiter: 'lib/**')
    #
    # @example Multiple path limiters
    #   grep = Git::Commands::Grep.new(execution_context)
    #   result = grep.call('HEAD', pattern: 'search', path_limiter: ['lib/**', 'spec/**'])
    #
    ...
    class Grep < Git::Commands::Base
      arguments do
        ...
        operand :tree
        value_option :path_limiter, as_operand: true, separator: '--', repeatable: true
      ...
      #
      #   @overload call(tree = nil, **options)
      #
      #     @param tree [String, nil] tree-ish to search (e.g. a commit SHA,
      #       tag, or branch name); when omitted, git searches the working tree
      #
      ...
      #       files. Only useful with +:untracked+.
      #
      ...
      #
      #     @option options [String, Array<String>] :path_limiter (nil) Limit the
