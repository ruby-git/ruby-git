  ...
  describe '#call' do
    context 'with no arguments' do
      it 'runs git clean without any flags' do
        ...
        expect_command_capturing('clean').and_return(expected_result)
    ...
    context 'with the :d argument' do
      it 'adds -d to the command line' do
        expect_command_capturing('clean', '-d').and_return(command_result)
    ...
    context 'with multiple options combined' do
      it 'includes all specified flags' do
        expect_command_capturing('clean', '-d', '--force', '-x').and_return(command_result)
