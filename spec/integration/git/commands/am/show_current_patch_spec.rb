...
RSpec.describe Git::Commands::Am::ShowCurrentPatch, :integration do
  ...
  describe '#call' do
    context 'when the command succeeds' do
      before do
        # Create a patch that will conflict when applied, leaving an am session in progress
        ...
        # Create a conflicting commit so that git am fails and leaves the session open
