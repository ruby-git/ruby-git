...
## [6.0.0](https://github.com/ruby-git/ruby-git/compare/v5.4.1...v6.0.0) (2026-09-22)


### ⚠ BREAKING CHANGES

* **path_resolver:** a relative :repository or :index option passed to a factory method is expanded against the process working directory instead of the working directory or git directory. Callers who relied on the old expansion pass the joined path explicitly.
...
* **factories:** Accept an :index option in Git.bare ([333d609](https://github.com/ruby-git/ruby-git/commit/333d6090bbd07cbd05a89e76ba5991327caeaf66)), closes [#1868](https://github.com/ruby-git/ruby-git/issues/1868)
...
* **path_resolver:** Expand relative :repository and :index against the process cwd ([5196d8e](https://github.com/ruby-git/ruby-git/commit/5196d8e28a369302bfe855f43694eff43b5343ea)), closes [#1871](https://github.com/ruby-git/ruby-git/issues/1871)
...
* Comment the hooks that mutate ENV and the working directory ([ea4c197](https://github.com/ruby-git/ruby-git/commit/ea4c1975e5f3385d6c3f8c8937ceefa19a3ceffd))
...
* **skills:** Add the testing-guide override skill ([54818b7](https://github.com/ruby-git/ruby-git/commit/54818b76502871b30824a0eeffab93d266c5c223))
...
* **skills:** Prefer not touching global state over restoring it ([784d4d4](https://github.com/ruby-git/ruby-git/commit/784d4d42cc13046f09c6844332d559c520f96017))
